...
<html>
            ...
            <div class="container"><a class="navbar-brand logo" href="#">Chip Land</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navbarNav"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="consumer-appoint.php">I'm a consumer</a></li>
                        <li class="nav-item"><a class="nav-link" href="plant-accept.php">I'm a plant owner</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <section class="portfolio-block block-intro">
                <div class="container">
                    ...
                    <div class="about-me">
                        ...
                        <a class="btn btn-outline-primary" role="button" href="consumer-appoint.php">I'm a consumer</a>
                        <a class="btn btn-outline-primary" role="button" href="plant-accept.php">I'm a plant owner</a>
                    </div>
                </div>
            </section>
            ...
            <section class="portfolio-block call-to-action border-bottom">
                <div class="container">
                    <div class="d-flex justify-content-center align-items-center content">
                        <h3>Log in to get more plants resources.</h3>
    ...
    <!-- backend: create database -->
        <?php
            ...
            if ($mysqli->errno) printf("Could not create database: %s<br />", $mysqli->error);
            //select database
