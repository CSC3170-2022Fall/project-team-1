<?php
if ($requiring_file_name == "consumer-signup.php") {
	$signup_file_name = "consumer-signin.php";
	$title = "Consumer Signup";
} else {
	$signup_file_name = "plant-signin.php";
	$title = "Plant Signup";
}
?>
...
<body>
	...
	<footer class="page-footer">
		<div class="container">
			<div class="links">
				<a href=<?php echo "$signup_file_name" ?>>Login in</a>
			</div>
		</div>
	</footer>
