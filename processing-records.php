...
<?php
    ...
    //$packages = $mysqli->query("SELECT * FROM Packages WHERE datediff(month,[dateadd],getdate())=0");
    $process = $mysqli->query("SELECT distinct `start_time`, `end_time` FROM Processing_Records");
    ...
    $operation = $mysqli->query("SELECT `operation_type` FROM Processing_Records");
